...
/* harmony import */ var _components_scrollTop__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/scrollTop */ "./src/js/components/scrollTop.js");
/* harmony import */ var _components_scrollTop__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_components_scrollTop__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_lazyLoadVideo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/lazyLoadVideo */ "./src/js/components/lazyLoadVideo.js");
/* harmony import */ var _components_lazyLoadVideo__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_lazyLoadVideo__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_dropdownMenu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/dropdownMenu */ "./src/js/components/dropdownMenu.js");
/* harmony import */ var _components_dropdownMenu__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_dropdownMenu__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _components_acc__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/acc */ "./src/js/components/acc.js");
/* harmony import */ var _components_acc__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_acc__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _functions_enable_scroll__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions/enable-scroll */ "./src/js/functions/enable-scroll.js");
...
// index.html страница :
// if (onIndexPage) {
//   const tabs1 = new GraphTabs('tab1');
// }
...
// const swiperAlboms = new Swiper('.main-alboms-swiper', {
//   loop: true,
//   navigation: {
//     nextEl: '.swiper-button-next',
//     prevEl: '.swiper-button-prev',
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  */
  ...
  const dropdownBtns = document.querySelectorAll('.nav__btn');
  const drops = document.querySelectorAll('.dropdown');
  dropdownBtns.forEach(el => {
    el.addEventListener('click', e => {
      let currentBtn = e.currentTarget;
      let drop = currentBtn.closest('.nav__item').querySelector('.dropdown');
      // let dropMenuHeight = drop.clientHeight;
      // console.log('dropMenuHeight', dropMenuHeight);
      ...
      if (drop.classList.contains('dropdown--active')) {
...
document.addEventListener('DOMContentLoaded', () => {
  const Numbers = document.querySelector(".pagination__list");
  const paginatedList = document.querySelector(".store__list");
  ...
  const disableButton = button => {
    button.classList.add("pagination__button_disabled");
    button.setAttribute("disabled", true);
  };
  const enableButton = button => {
    button.classList.remove("pagination__button_disabled");
  ...
  const appendPageNumber = index => {
    ...
    pageNumber.className = "number pagination__button";
...
document.addEventListener('DOMContentLoaded', () => {
  const Numbers = document.querySelector(".pagination__list");
  const paginatedList = document.querySelector(".news-gallery__list-news");
  const listItems = paginatedList?.querySelectorAll("li");
  const nextButton = document.querySelector(".pagination__button_next");
  const prevButton = document.querySelector(".pagination__button_prev");
...
//   if (page > 1) {
//     liTag += `<li class="pagination__item pagination__item_flex">
//                   <button class="pagination__button pagination__button_prev" onclick="element(totalPages, ${page - 1})">Назад</button>
//               </li>`;
//   }

//   if (page > 2) {

//     liTag += `<li class="pagination__item number">
//                   <button class="pagination__button">1</button>
//               </li>`;

//     if (page > 3) {
//       liTag += `<li class="pagination__item dots">
...
//     if (page === pageLength) {
//       activeLi = `pagination__item_active`;
//     } else {
//       activeLi = ``;
//     }

//     liTag += `<li class="pagination__item number ${activeLi}">
//                   <button class="pagination__button" onclick="element(totalPages,${pageLength})">${pageLength}</button>
//               </li>`;
//   }
...
//     liTag += `<li class="pagination__item number">
//                   <button class="pagination__button">${totalPages}</button>
//               </li>`;
...
//   if (page < totalPages) {
//     liTag += `<li class="pagination__item pagination__item_flex">
//                   <button class="pagination__button pagination__button_next" onclick="element(totalPages,${page + 1})">Вперёд</button>
//               </li>`;
//   }
...
document.addEventListener('DOMContentLoaded', () => {
  (function () {
    ...
    const mobileFooter = document?.querySelector('[data-menu-footer]');
    const drops = document.querySelectorAll('.dropdown');
    console.log(burger);
    ...
    overlay?.addEventListener('click', () => {
      ...
      mobileFooter.classList.remove('mobile-footer--active');
      (0,_functions_enable_scroll__WEBPACK_IMPORTED_MODULE_1__.enableScroll)();
    });
